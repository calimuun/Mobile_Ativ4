package com.calielian.task.ui.adapter
...
import com.calielian.task.databinding.ItemTaskBinding

class TaskAdapter(
    private val context: Context,
    private val taskSelected: (Task, Int) -> Unit
) : ListAdapter<Task, TaskAdapter.MyViewHolder>(DIFF_CALBCK) {
    ...
    companion object {
        ...
        private val DIFF_CALBCK = object : DiffUtil.ItemCallback<Task>(){
